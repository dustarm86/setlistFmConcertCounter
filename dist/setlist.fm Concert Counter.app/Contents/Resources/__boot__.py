...
_path_inject(['/Users/dieter/python/setlistFmConcertCounterRepo'])
...
DEFAULT_SCRIPT='/Users/dieter/python/setlistFmConcertCounterRepo/setlistFmConcertCounterGUI.py'
SCRIPT_MAP={}
try:
    _run()
